...
void runTests()
{
    ...
    if (testCreateEmptyList())
        passedTests++;
    totalTests++;
    if (testAddSingleElement())
        passedTests++;
    totalTests++;
    if (testAddMultipleElementsSorted())
        passedTests++;
    totalTests++;
    if (testAddDuplicates())
        passedTests++;
    totalTests++;
    if (testRemoveExistingElement())
        passedTests++;
    totalTests++;
    if (testRemoveNonExistingElement())
        passedTests++;
    totalTests++;
    if (testRemoveFromEmptyList())
        passedTests++;
    totalTests++;
    if (testPositionInEmptyList())
        passedTests++;
    totalTests++;
    if (testPositionAtBeginning())
        passedTests++;
    totalTests++;
    if (testPositionAtEnd())
        passedTests++;
    totalTests++;
